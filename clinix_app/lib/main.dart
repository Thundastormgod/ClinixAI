...
import 'features/triage/presentation/symptom_input_screen.dart';
import 'features/triage/presentation/voice_triage_screen.dart';
import 'features/triage/presentation/emergency_screen.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/triage': (context) => const SymptomInputScreen(),
        '/triage/voice': (context) => const VoiceTriageScreen(),
